...
namespace Clbio.Application.Interfaces.EntityServices
{
    public interface ITaskAppService
    {
        ...
        Task<Result<ReadTaskItemDto>> CreateAsync(Guid workspaceId, CreateTaskItemDto dto, CancellationToken ct = default);
        Task<Result> MoveTaskAsync(Guid workspaceId, Guid taskId, Guid targetColumnId, int newPosition, CancellationToken ct = default);
